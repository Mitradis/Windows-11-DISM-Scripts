...
if not exist %windir%\zh-CN\explorer.exe.mui (
	...
	%programdata%\PostClear\HelpTool.exe %DLLEDIT% "74 1F 48 63 D0 48 8D 0D C1 E9 02 00 48 C1 E2 04 48 03 D1 48 8B CF 48 89 57 60 8B D0 E8 28 02 00 00" "90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90"
